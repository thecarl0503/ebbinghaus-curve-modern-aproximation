...
clases_en_semana={1:("E"), 2:("F", "L"), 3:(), 4:("F"), 5:(), 6:(), 7:()}
    #tiempos enteros, si enfocamos el tipo de estudio en un tema completo, tiempos cuartos 1/4 de tema
tiempos_enteros_teoricos={1:150, 2:100, 3:50, 4:25}
#tiempos_cuartos_teoricos={1:40, 2:25, 3:12.5, 4:6.25}
tiempos_cuartos_teoricos={1:40, 2:36, 3:32, 4:28}
tiempos_cuartos_practicos={1:100, 2:100, 3:100, 4:50}
#a:10 ejercicios nivel examen #b:100
    #1.3 Autores Absolutos, 10 autores para convertirse de 0 a heroe, o menos si es que no hay prisa
a_fisica=["Zemanky", "Resnick&Krane","Feynman"]
a_calculo=[ "Dennis Zill", "Stewart"]
# en calculo "Rogawsky" también podria ser 4to
a_laboratorio=["Youtube","Purcell"]

a_estadistica=["Moya","Marian"]
masters={"F":a_fisica,"C":a_calculo,"L":a_laboratorio,"E":a_estadistica}
#a_timehacks=["Alan garcia","Libro2","Libro3"]
#a_biofísica=["gonzales ibeas","pravar kumac", "Philip Nelson"]
#a_inglés=["cambridge1", "cambridge 2"]
e=(ma.exp(1))
#2. FECHAS CLASE
...
#ORDENAMOS Y ELEGIMOS LA FECHA MÁS LEJANA
diferencias={}
...
#ELEGIMOS EL RANGO DE DIAS Y ESPACIOS DISPONIBLES
...
#FALTA SUMAR AL CONTADOR BRUTO LAS CLASES 
agenda={}
...
for quien in cl_de_materias.items():
    repe={}

    contador_bruto[quien[0]]=repe

print("11111111111111111",contador_bruto)


#print("LLLLLLLLLLLLLLLL",contador_bruto)
#print("DIAS Y ESPACIOS DISPONIBLES 1",dias_y_espacios_disponibles)
#############################################COMIENZA LA CARNICERIA###############3

while (list(set(cl_de_materias.values())))!=[1]:
